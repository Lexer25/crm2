...
return array
(
	'contCount'						=> 'Найдено всего :totalCount записей. Будут показаны первые :contCount записей. При необходимости пользуйтесь поиском.',
	'npp'						=> '№ п/п',
	...
	'report.title'				=> 'Отчет Учет рабочего времени для сотрудника :surname :name  :patronymic за период c :timefrom по :timeTo',
	'report.date'				=> 'Дата',
	'report.org'				=> 'Отдел',
	'report.pepname'			=> 'ФИО',
	...
	'report.doorlist.title'				=> 'Отчет перечень точек прохода для сотрудника :surname :name  :patronymic',
	...
	'sidebar.contactslist'			=> 'Список сотрудников',
	'sidebar.addcontact'			=> 'Добавить сотрудника',
	...
	'acl.contactwork'				=> 'Работа с сотрудниками',
	...
	'contacts.confirmdelete'		=> 'Вы действительно хотите удалить сотрудник?',
	'contacts.confirmSetNotActive'	=> 'сотрудник будет уволенный.\r\nсотрудник можно восстановить в разделе сотрудникы - Уволенные.',
	'contacts.restore'				=> 'Вы действительно хотите восстановить сотрудник?',

	'contact.title'					=> 'сотрудник',
	...
	'contact.saved'					=> 'сотрудник сохранен',
	'contact.updated'				=> 'сотрудник обновлен',
	'contact.deleted'				=> 'сотрудник удален',
	'contact.setNotActiveOK'		=> 'сотрудник :surname :name :patronymic отмечен как УВОЛЕННЫЙ',
	'contact.setNotActiveErr'		=> 'Ошибка при попытке пометить сотрудник :surname :name :patronymic как УВОЛЕННЫЙ',
	'contact.deleteOK'				=> 'сотрудник :surname :name :patronymic удален',
	'contact.deleteErr'				=> 'Ошибка при удалении сотрудника :surname :name :patronymic',
	'contact.setIsActiveOK'			=> 'сотрудник :surname :name :patronymic помечен как активный',
	'contact.setIsActiveErr'		=> 'Ошибка при попытке пометить сотрудник :surname :name :patronymic как АКТИВНЫЙ',
	'contact.titleEditContact'		=> 'Редактирование сотрудника :surname :name :patronymic',
	'contact.titleEditContactAddId'		=> 'Добавление идентификатора  сотруднику :surname :name :patronymic',
	'contact.titleCardList'			=> 'Список идентификаторов сотрудника :surname :name :patronymic',
	'contact.titlefiredContact'		=> 'Просмотр удаленного сотрудника :surname :name :patronymic',
	...
	'contact.addOK'					=> 'Новый сотрудник добавлен успешно',
	'contact.updateOk'				=> 'сотрудник обновлен успешно',
	'contact.key_occuped'			=>'Отказ в выдаче карты. Карта :idcard зарегистрирована на сотрудник '.HTML::anchor('guests/edit/:id_pep/guest_mode', ':surname :name :patronymic'),
	...
	'contacts.count_identificator_rfid'			=>'Наличие идентификатора Список карт',
	...
	'guest.key_occuped_contact'		=>'Отказ в выдаче карты. Карта :idcard принадлежит сотруднику :surname :name :patronymic',
	...
	'sidebar.deletedcontact'		=> 'Уволенные сотрудники',
	'sidebar.rfid'					=> 'Список карт',
	'sidebar.grz'					=> 'ГРЗ',
	'sidebar.uhf'					=> 'UHF',
	...
	'companies.countContact'		=> 'Количество сотрудников в компаний',
	...
	'company.contacts'				=> 'Список сотрудников',
	...
	'button.addpeople'				=> 'Добавить сотрудника',
	'button.totalDelete'			=> 'Удалить сотрудник',
	...
	'button.reportEvents'			=> 'Подготовить Журнал событий',
	'Reports'						=> 'Отчеты',
	'report.history'				=> 'Журнал событий',
	...
	'acl.contact_view'				=> 'Просмотр сотрудников',
	'acl.contact_edit'				=> 'Редактирование сотрудников',
	...
	'form.editContact'				=>'Редактирование сотрудника',
	'form.select_file_enabled_in_edit_mode'				=>'Выбор файла с изображением доступен только в режиме редактирования сотрудника',

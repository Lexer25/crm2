			...
			<table class="data tablesorter-blue" width="100%" cellpadding="0" cellspacing="0" id="tablesorter" >
				<thead>
					<tr>
						...
						echo '<th class="filter-false sorter-false">' . __('companies.countChildren') . '</th>';
						echo '<th class="filter-false sorter-false">' . __('companies.countContact') . '</th>';
						echo '<th class="filter-false sorter-false">' . __('companies.code') . '</th>';

...
<h1 style="text-align: left">Список сотруников в точке прохода под управлением СКУД</h1>
</td>
...
<td class="center" style="width: 15%">ФИО</td>
<td class="center" style="width: 15%">Организация</td>
<td class="center" style="width: 15%">Должность</td>
...
<?php
	...
	foreach ($dataForSave as $key=>$value){
		...
		//echo Debug::vars('1853', $key, $value); exit;
		echo '<tr class="list_row">';
			...
			echo '<td class="left">'. Arr::get($value, 'fio').'</td>';
			echo '<td class="left">'. Arr::get($value, 'org').'</td>';
			echo '<td class="left">'. Arr::get($value, 'post').'</td>';
...
<tr class="foot">
<td colspan="2" class="left"><strong>Всего сотрудников:</strong></td>

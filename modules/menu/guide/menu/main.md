...
Связь пунктов меню с правами пользователя устанавливается в файле \modules\menu\config\menu\moduleMenu.php и имеет следующий вид:  
~~~
	'configMenu'=>array(
			'home'=>array(),
			'org'=>array(MANCARD),
...
Настройка режима работы производится в файле \modules\menu\config\menu\moduleMenu.php путем изменения имени рабочего набора меню.  

<fieldset style="max-width: 400px;">
    ...
    <div>
		...
		<!-- Добавляем класс doc-fields-row к таблице -->
		<table align="left" class="doc-fields-row">
            <tr>
                <td>
                    ...
                    if (!empty($guest->numdoc)) {
                        ...
                        $currentDocType = isset($parts[1]) ? $parts[1] : '1';
...
<!-- 17.02.2026 Весь JavaScript ПОЛНОСТЬЮ УДАЛЕН Навигация по Enter теперь будет работать только из основного скрипта в edit.php -->
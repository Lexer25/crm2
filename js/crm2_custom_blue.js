...
$(document).ready(function() {
	...
	if (location.href.indexOf('/companies') != -1)
		$('#sidebar_companies').click().blur();
	else if (location.href.indexOf('/contacts') != -1)
		$('#sidebar_contacts').click().blur();
	else if (location.href.indexOf('/cards') != -1)
		$('#sidebar_cards').click().blur();
	else if (location.href.indexOf('/users') != -1)
		$('#sidebar_users').click().blur();
	else if (location.href.indexOf('/eventlog') != -1)
		$('#sidebar_eventlog').click().blur();
	else if (location.href.indexOf('/queue') != -1)
		$('#sidebar_queue').click().blur();
	else if (location.href.indexOf('/stats') != -1)
		$('#sidebar_stats').click().blur();
